...
* Depends on computer capacity; we also provide results using the sample data.
  ...
  - `Post_regularization_LASSO_Poisson_Model_Estimates.csv` contains the results of the estimation for the Post-regularization LASSO Poisson model (Table 22--25).		
